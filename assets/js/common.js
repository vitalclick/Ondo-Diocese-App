...
function delete_item(e){
  ...
  switch(type){
    case 'ebooks':
       var msg = 'You want to delete this book';
       url = baseURL+'deleteEbook/'+id;
    break;
    case 'prayer':
       var msg = 'You want to delete this prayer item';
