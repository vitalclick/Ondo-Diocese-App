                                  ...
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      <div class="btn-group btn-group-sm" style="float: none;">
                                        ...
                                        <button onclick="delete_item(event)" data-type="ebooks" data-id="<?php echo $record->id; ?>" type="button" class="btn btn-danger btn-lg m-l-15 waves-effect" style="float: none;">
                                         <i style="color:white;margin-bottom:5px;"  class="material-icons list-icon" data-type="ebooks" data-id="<?php echo $record->id; ?>">delete</i>
                                        </button>
                                      </div>
                                    </td>
                                   </tr>
