...
class Donations extends BaseController
{
	...
	function updatedonationSettings()
	{
		...
		$data = array(
			'paystack_key' => $this->input->post('paystack_key'), 'flutterwaves_key' => $this->input->post('flutterwaves_key'), 'flutterwaves_currency_code' => $this->input->post('flutterwaves_currency_code'), 'paypal_link' => $this->input->post('paypal_link')
		);
