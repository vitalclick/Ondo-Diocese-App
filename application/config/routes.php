...
$route['fetch_books'] = "api/fetch_books";
$route['fetch_inbox'] = "api/fetch_inbox";
$route['devotionals'] = "api/devotionals";
$route['purchasebook'] = "api/purchasebook";
$route['fetch_events'] = "api/fetch_events";
$route['fetch_prayerpoints'] = "api/fetch_prayerpoints";
$route['submitprayer'] = "api/submitprayer";
...
$route['counsellingrequest'] = 'account/counsellingrequest';
...
//prayer routes
$route['getPrayers'] = 'prayers/getPrayers';
$route['prayersListing'] = 'prayers/prayersListing';
$route['newPrayer'] = 'prayers/newPrayer';
$route['saveNewPrayer'] = 'prayers/saveNewPrayer';
$route['editPrayer/(:num)'] = 'prayers/editPrayer/$1';
$route['editPrayerData'] = 'prayers/editPrayerData';
$route['deletePrayer/(:num)'] = 'prayers/deletePrayer/$1';
...
//books
$route['ebooksListing'] = 'books';
$route['newEbook'] = 'books/newEbook';
$route['savenewebook'] = 'books/savenewebook';
$route['editEbook/(:num)'] = 'books/editEbook/$1';
$route['editEbookData'] = 'books/editEbookData';
$route['deleteEbook/(:num)'] = 'books/deleteEbook/$1';
$route['deletereportedbook/(:num)'] = 'books/deleteReport/$1';

$route['getBookPurchases'] = 'books/getBookPurchases';
$route['bookpurchases'] = 'books/bookpurchases';
